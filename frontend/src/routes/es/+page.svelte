<script lang="ts">
  ...
  const jsonLd = {
    ...
    '@type': 'WebApplication',
    name: 'CleanPoker',
    url: 'https://cleanpoker.dev/es',
    description: 'Herramienta gratuita de planning poker colaborativo. Sin cuenta, sin rastreo.',
...
<svelte:head>
  <title>CleanPoker | Planning poker gratis, sin cuenta</title>
  <meta name="description" content="Planning poker colaborativo y gratuito. Crea una sesión, comparte el enlace, estima en equipo. Sin cuenta, sin rastreo. Accesible WCAG 2.1 AA." />
  <link rel="canonical" href="https://cleanpoker.dev/es" />
  ...
  <meta property="og:url" content="https://cleanpoker.dev/es" />
  <meta property="og:title" content="CleanPoker | Planning poker gratis, sin cuenta" />
  <meta property="og:description" content="Crea una sesión, comparte el enlace, estima en equipo. Listo en 30 segundos." />
  <meta property="og:image" content="https://cleanpoker.dev/og-image.png" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="CleanPoker | Planning poker gratis, sin cuenta" />
  <meta name="twitter:description" content="Crea una sesión, comparte el enlace, estima en equipo. Listo en 30 segundos." />
...
<div class="page">
  ...
  <main id="main" class="hero container">
    <h1>Planning poker<br /><span class="accent">crear · votar · decidir</span></h1>
    <p class="lead">Crea una sesión, comparte el enlace, estima en equipo. Listo en 30 segundos.</p>

    <form class="create-form" onsubmit={(e) => { e.preventDefault(); createRoom(); }}>
      <div class="cards-field">
        <label for="cards-input">Cartas <span class="label-hint">(separadas por comas)</span></label>
        <div class="presets" role="group" aria-label="Preajustes">
      ...
      <button type="submit" class="btn btn-primary btn-lg" disabled={creating || !isValid}>
        {creating ? 'Creando…' : 'Crear una sesión'}
      </button>
      <p class="hint">Comparte el enlace. Es todo.</p>
    </form>
  </main>
