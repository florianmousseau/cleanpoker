<script lang="ts">
  ...
  const jsonLd = {
    ...
    '@type': 'WebApplication',
    name: 'CleanPoker',
    url: 'https://cleanpoker.dev/pt',
    description: 'Ferramenta gratuita de planning poker colaborativo. Sem conta, sem rastreamento.',
  ...
  async function createRoom() {
    ...
    try {
      ...
      error = 'Não foi possível criar a sala. Tente novamente.';
    } finally {
      creating = false;
    }
  }
...
<svelte:head>
  <title>CleanPoker | Planning poker gratuito, sem conta</title>
  <meta name="description" content="Planning poker colaborativo e gratuito. Crie uma sessão, partilhe o link, estime em equipa. Sem conta, sem rastreamento. Acessível WCAG 2.1 AA." />
  <link rel="canonical" href="https://cleanpoker.dev/pt" />
  ...
  <meta property="og:url" content="https://cleanpoker.dev/pt" />
  <meta property="og:title" content="CleanPoker | Planning poker gratuito, sem conta" />
  <meta property="og:description" content="Crie uma sessão, partilhe o link, estime em equipa. Pronto em 30 segundos." />
  <meta property="og:image" content="https://cleanpoker.dev/og-image.png" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="CleanPoker | Planning poker gratuito, sem conta" />
  <meta name="twitter:description" content="Crie uma sessão, partilhe o link, estime em equipa. Pronto em 30 segundos." />
...
<div class="page">
  ...
  <main id="main" class="hero container">
    <h1>Planning poker<br /><span class="accent">criar · votar · decidir</span></h1>
    <p class="lead">Crie uma sessão, partilhe o link, estime em equipa. Pronto em 30 segundos.</p>

    <form class="create-form" onsubmit={(e) => { e.preventDefault(); createRoom(); }}>
      <div class="cards-field">
        <label for="cards-input">Cartas <span class="label-hint">(separadas por vírgulas)</span></label>
        <div class="presets" role="group" aria-label="Predefinições">
        ...
        <p id="cards-preview" class="cards-preview" aria-live="polite">
          ...
          {/each}
          {#if !isValid}
            <span class="cards-error">Mínimo 2 cartas</span>
          {/if}
        </p>
      </div>
      ...
      <button type="submit" class="btn btn-primary btn-lg" disabled={creating || !isValid}>
        {creating ? 'A criar…' : 'Criar uma sessão'}
      </button>
      <p class="hint">Partilhe o link. É tudo.</p>
    </form>
  </main>
