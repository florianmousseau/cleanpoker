<script lang="ts">
  ...
  const jsonLd = {
    ...
    '@type': 'WebApplication',
    name: 'CleanPoker',
    url: 'https://cleanpoker.dev/de',
    description: 'Kostenloses kollaboratives Planning-Poker-Tool. Kein Konto, kein Tracking.',
  ...
  async function createRoom() {
    ...
    try {
      ...
      error = 'Raum konnte nicht erstellt werden. Bitte erneut versuchen.';
    } finally {
      creating = false;
    }
  }
...
<svelte:head>
  <title>CleanPoker | Kostenloses Planning Poker, kein Konto nötig</title>
  <meta name="description" content="Kostenloses kollaboratives Planning Poker. Session erstellen, Link teilen, gemeinsam schätzen. Kein Konto, kein Tracking. WCAG 2.1 AA barrierefrei." />
  <link rel="canonical" href="https://cleanpoker.dev/de" />
  ...
  <meta property="og:url" content="https://cleanpoker.dev/de" />
  <meta property="og:title" content="CleanPoker | Kostenloses Planning Poker, kein Konto nötig" />
  <meta property="og:description" content="Session erstellen, Link teilen, gemeinsam schätzen. In 30 Sekunden startklar." />
  <meta property="og:image" content="https://cleanpoker.dev/og-image.png" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="CleanPoker | Kostenloses Planning Poker, kein Konto nötig" />
  <meta name="twitter:description" content="Session erstellen, Link teilen, gemeinsam schätzen. In 30 Sekunden startklar." />
...
<div class="page">
  <header class="header">
    <div class="container header-inner">
      ...
      <nav class="lang-nav" aria-label="Sprache">
        <a href="/" class="lang-link" hreflang="fr">FR</a>
  ...
  <main id="main" class="hero container">
    <h1>Planning Poker<br /><span class="accent">erstellen · abstimmen · entscheiden</span></h1>
    <p class="lead">Session erstellen, Link teilen, gemeinsam schätzen. In 30 Sekunden startklar.</p>

    <form class="create-form" onsubmit={(e) => { e.preventDefault(); createRoom(); }}>
      <div class="cards-field">
        <label for="cards-input">Karten <span class="label-hint">(kommagetrennt)</span></label>
        <div class="presets" role="group" aria-label="Voreinstellungen">
        ...
        <p id="cards-preview" class="cards-preview" aria-live="polite">
          ...
          {/each}
          {#if !isValid}
            <span class="cards-error">Mindestens 2 Karten</span>
          {/if}
        </p>
      </div>
      ...
      <p class="hint">Link teilen. Fertig.</p>
    </form>
  </main>
