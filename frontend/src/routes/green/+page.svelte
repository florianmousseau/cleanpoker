<svelte:head>
  ...
  {@html `<script type="application/ld+json">${JSON.stringify({
    ...
    isPartOf: {
      ...
      sustainabilityNote: 'Hosted on renewable energy (Cloudflare Pages + Fly.io CDG Paris). JS bundle under 50 KB brotli. No third-party script. CO2 under 0.1 g per visit.',
    },
  })}<\/script>`}
</svelte:head>
...
<div class="page container">
  <main id="main">
    ...
    <ul>
      ...
      <li><strong>No third-party script</strong>: no Analytics SDK, no Chat, no A/B testing</li>
    ...
    <p>
      The JS bundle size is checked on every change and blocks the deployment if it exceeds
      the limit. Lighthouse scores and the pipeline energy consumption (Eco-CI) are measured
      at every deployment and published in the CI results.
    </p>
