<svelte:head>
  ...
  <link rel="canonical" href="https://cleanpoker.dev/en/planning-poker" />
  ...
  {@html `<script type="application/ld+json">${JSON.stringify({
    ...
    url: 'https://cleanpoker.dev/en/planning-poker',
...
<div class="page container">
  <main id="main">
    <a href="/en/a-propos" class="back-link">← About</a>
    ...
    <div class="cta">
      <a href="/en" class="btn">Create a free session →</a>
    </div>
  </main>
