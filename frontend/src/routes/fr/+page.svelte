...
<HomepageTemplate
  ...
  metaDesc="Planning poker gratuit, éco-conçu, zéro trackers, zéro cookie publicitaire. Accessible WCAG 2.1 AA : navigation clavier, lecteurs d'écran (NVDA, VoiceOver). Bundle JS < 50 Ko. Hébergement vert. Sans compte."
  ...
  jsonLdDesc="Outil de planning poker collaboratif, gratuit, éco-conçu et sans compte. Zéro trackers, zéro cookie publicitaire, zéro pub. Bundle JS < 50 Ko. Hébergement sur énergie renouvelable. Accessible WCAG 2.1 AA : navigation clavier, lecteurs d'écran NVDA et VoiceOver."
